import{_ as l,r as i,c as d,b as n,d as s,e as c,w as t,a as e,o as p}from"./app-unJBmhHn.js";const r={},v=e(`<h2 id="javascript" tabindex="-1"><a class="header-anchor" href="#javascript"><span>javascript</span></a></h2><h3 id="泛型" tabindex="-1"><a class="header-anchor" href="#泛型"><span>泛型</span></a></h3><ul><li>ts 是强类型,他的变量和方法都有类型的限制.但是当一个方法可能会有多个类型的返回值的时候,我们可以自己定义一个类型来表示他的返回值的类型,通常我们自己定义的这个类型,就是泛型;</li></ul><h3 id="闭包" tabindex="-1"><a class="header-anchor" href="#闭包"><span>闭包</span></a></h3><ul><li>函数及其周围状态的应用捆绑在一起构成闭包,闭包可以让内部函数访问外部函数作用域</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">// 最基础的闭包</span>
