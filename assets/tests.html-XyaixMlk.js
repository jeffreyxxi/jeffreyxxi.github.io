import{_ as l,c as d,a,b as s,d as e,e as c,w as p,r as t,o as r}from"./app-CzxXQkrq.js";const v={};function u(m,n){const i=t("RouteLink");return r(),d("div",null,[n[6]||(n[6]=a(`<h2 id="javascript" tabindex="-1"><a class="header-anchor" href="#javascript"><span>javascript</span></a></h2><h3 id="泛型" tabindex="-1"><a class="header-anchor" href="#泛型"><span>泛型</span></a></h3><ul><li>ts 是强类型,他的变量和方法都有类型的限制.但是当一个方法可能会有多个类型的返回值的时候,我们可以自己定义一个类型来表示他的返回值的类型,通常我们自己定义的这个类型,就是泛型;</li></ul><h3 id="闭包" tabindex="-1"><a class="header-anchor" href="#闭包"><span>闭包</span></a></h3><ul><li>函数及其周围状态的应用捆绑在一起构成闭包,闭包可以让内部函数访问外部函数作用域</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">// 最基础的闭包</span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="this-的指向问题" tabindex="-1"><a class="header-anchor" href="#this-的指向问题"><span>this 的指向问题</span></a></h3><h4 id="全局环境下" tabindex="-1"><a class="header-anchor" href="#全局环境下"><span>全局环境下</span></a></h4><ul><li>this 指向全局对象，即浏览器中指向 window，node 中指向 global</li></ul><h4 id="函数环境下" tabindex="-1"><a class="header-anchor" href="#函数环境下"><span>函数环境下</span></a></h4>`,10)),s("ul",null,[n[2]||(n[2]=s("li",null,[s("p",null,"函数内部，this 的取值范围取决于函数被调用的方式")],-1)),n[3]||(n[3]=s("li",null,[s("p",null,"简单调用，如果 this 值不是由调用设置的，则指向全局对象，严格模式下为 undefined；")],-1)),s("li",null,[s("p",null,[n[1]||(n[1]=e("call(),apply()和 bind() 函数内时， 参考 ",-1)),c(i,{to:"/javascript.html#call-apply-bind"},{default:p(()=>[...n[0]||(n[0]=[e("call(),apply(),bind()",-1)])]),_:1})])]),n[4]||(n[4]=s("li",null,[s("p",null,"在箭头函数中，this 与封闭词法环境的 this 保持一致。在全局代码中，它将被设置为全局对象。")],-1)),n[5]||(n[5]=s("li",null,[s("p",null,"当函数作为对象里的方法被调用时，它们的 this 是调用该函数的对象。")],-1))]),n[7]||(n[7]=a(`<h3 id="let、var、const-的区别" tabindex="-1"><a class="header-anchor" href="#let、var、const-的区别"><span>let、var、const 的区别</span></a></h3><ul><li>var 没有块级作用域，支持变量提升。</li><li>let 有块级作用域，不支持变量提升。不允许重复声明，暂存性死区。不能通过 window.变量名进行访问.</li><li>const 有块级作用域，不支持变量提升，不允许重复声明，暂存性死区。声明一个变量一旦声明就不能改变，改变报错。</li></ul><h3 id="变量提升" tabindex="-1"><a class="header-anchor" href="#变量提升"><span>变量提升</span></a></h3><p><em><strong><span style="color:#F56C6C;">作用域就是程序中定义变量的区域，该位置决定了变量的生命周期。通俗理解，作用域就是变量与函数的可访问范围，即作用域控制着变量和函数的可见性和生命周期。</span></strong></em></p><ul><li>变量提升是指在 JavaScript 代码执行过程中，JavaScript 引擎把变量的声明部分和函数的声明部分提升到代码开头的行为。变量被提升后，会给变量设置默认值为 undefined。</li><li>使用 var 声明变量,不管变量写在哪里,都会被提前到作用域的顶端,全局变量会被提升到全局作用域的顶端,函数内部的变量会被提升到函数作用域的顶端;</li><li>使用变量形式声明函数时，和普通的变量一样会存在提升的现象，而函数声明式会提升到作用域最前边，并且将声明内容一起提升到最上边。</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">fn()</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>index.js 代码</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">var instance = new Vue({</span>
<span class="line">  el: &quot;app&quot;,</span>
<span class="line">  data: {</span>
<span class="line">    text: &quot;123&quot;</span>
<span class="line">  }</span>
<span class="line">})</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>vue 代码</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">function Dep(){</span>
